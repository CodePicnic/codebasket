...
App = React.createClass({
  ...
  hideOptionsList: function(event) {
    if (this.refs.tabsContainer && this.refs.tabsContainer.isMounted() && !event.target.classList.contains('fa-cog')) {
  ...
  render: function() {
    var codeBasket = this.props.codeBasket,
        ...
        sidebarSize = (this.state.isSidebarVisible ? userDefinedSidebarSize : 1),
        registerLink;
