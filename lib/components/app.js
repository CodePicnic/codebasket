    ...
    return (
      <main ref="main" className="console-container" onClick={this.hideOptionsList}>
        <div className="console-container-wrapper">
          ...
          <Footer isFullScreen={this.state.isFullScreen} isProgressBarVisible={this.state.isProgressBarVisible} status={codeBasket.status} permanentStatus={codeBasket.permanentStatus} users={codeBasket.users} currentUser={codeBasket.currentUser} />
        </div>
      </main>
    );
  }
