  ...
  renderFileOrFolderActions: function(item) {
    return (
      <nav className="codebasket-item-actions">
        <i className="fa fa-edit" onClick={this.onClickEditFileOrFolder.bind(this, item)}></i>
        <i className="fa fa-trash-o" onClick={this.onClickRemoveFileOrFolder.bind(this, item)}></i>
      </nav>
    );
  }
};