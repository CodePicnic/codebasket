...
module.exports = {
  ...
  renderFileOrFolderActions: function(item) {
    var instance = this.props.instance,
        editButton = (this.isItemAFile(item) && instance.findFile(item.path)) ? <span className="icon edit" title="Edit" onClick={this.onClickEditFileOrFolder.bind(this, item)}>C</span> : undefined;
