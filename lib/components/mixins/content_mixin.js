...
module.exports = {
  ...
  toggleOptionsList: function() {
    this.setState({ isOptionsListVisible: !this.state.isOptionsListVisible, isAsideVisible: false });
  },
  toggleAside: function() {
    this.setState({ isAsideVisible: !this.state.isAsideVisible, isOptionsListVisible: false });
  },
