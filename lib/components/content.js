    ...
    return (
      <section className={'codebasket-content' + contentClasses}>
        ...
        <nav className="codebasket-navbar codebasket-navbar-global">
          ...
          {visibleActions.map(this.renderNavButton)}
        ...
        <Viewport ref="viewport_1" viewportClasses={primaryViewportClasses} items={filter(items, function(item) { return item.pane !== 'secondary'; })} instance={instance} />
      </section>
    );
  }
});
