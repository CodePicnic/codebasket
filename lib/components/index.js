  ...
  render: function() {
    ...
    return (
      <section className="codebasket-main">
        <Sidebar isVisible={this.state.isSidebarVisible} actions={instance.sidebarActions} instance={instance} />
        <Content splitMode={this.state.splitMode} actions={instance.actions} instance={instance} />
