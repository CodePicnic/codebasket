...
Sidebar = React.createClass({
  ...
  renderFilesList: function(items) {
    ...
    return (
      <ul className={'codebasket-items-list files ' + dragSidebarClass}
        ...
        <li className="codebasket-list-title">
          Files
          <nav className="codebasket-item-actions">
            <span className="text" onClick={this.onClickCollapseAll}>Collapse all</span>
          </nav>
        </li>
  ...
  render: function sidebarRender() {
    var instance = this.props.instance,
        ...
        iframes = filter(instance.items, function(item) { return item.type === undefined || item.type.match(/iframe|browser/); }),
    ...
    return (
      <aside className={'codebasket-sidebar ' + parentClasses}>
        ...
        <article className="codebasket-sidebar-content">
          {this.renderItemsList(iframes, 'Sections')}
