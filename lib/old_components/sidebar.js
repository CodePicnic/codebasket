  ...
  renderFolder: function(fileName, fileInfo) {
    ...
    return (
      <dl className={collapsedClass} key={fileInfo.name}>
        <dt className={'directory' + dragClass + activeClass} title={fileInfo.path} onDragEnter={this.onDragEnter.bind(this, fileInfo.path)} onDragLeave={this.onDragLeave.bind(this, fileInfo.path)} onDrop={this.onDrop.bind(this, fileInfo.path)}>
          <span className="entry-text" onClick={this.toggleFolder.bind(null, fileInfo)}>{fileInfo.name}</span>
          <span href="#" className="remove-entry" onClick={this.removeFileOrFolder.bind(null, fileName, fileInfo)}><i className="icon icon-delete"></i></span>
        </dt>
  ...
  renderFile: function(fileName, fileInfo) {
    ...
    return (
      <dd className={'file' + fileTypeClass + isExecutableClass + activeClass} title={fileInfo.path} key={fileName}>
        ...
        <span className="remove-entry" onClick={this.removeFileOrFolder.bind(null, fileName, fileInfo)}><i className="icon icon-delete"></i></span>
      </dd>
    );
  },
